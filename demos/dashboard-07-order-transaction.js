...
(function () {
  ...
  const ORDER_ROWS = [
    ...
    ["8", "20260710-048", "07/10/2026 07:03 pm", chip("refund", "Refund"), "POS", "Jordan K.", "$77.60", "$0.00", "$6.60", "$0.00"],
  ];
  ...
  const TXN_ROWS = {
    ...
    "Refund": [
      ...
      ["07/10/2026 08:24 pm", "20260710-048", "Refund", "Credit card", "Full refund &mdash; wrong order fired", "-$77.60", "-$11.60", "$0.00", "$2.87", "-$86.33"],
    ],
    "Adjust fee": [
